...
public class ProprietarioController {
    ...
    @PostMapping
    public ResponseEntity<ProprietarioResponse> cadastrar(@RequestBody @Valid ProprietarioRequest request) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProprietarioResponse> atualizar(@PathVariable Long id, @RequestBody @Valid ProprietarioRequest request) {
